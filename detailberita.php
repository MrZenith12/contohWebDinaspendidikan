                ...
                <div class="blog-wrapper blog-list blog-details blue-blog mb-50">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        <div class="blog-thumb mb-35">
                            <img src="admin/berita/gambar/<?php echo $gambar; ?>" alt="">
                ...
                <div class="sidebar-wrapper">
                    <div class="sidebar-widget mb-40">
                        ...
                        <ul class="post-list">
                            ...
                            $query_lainnya = "SELECT * FROM tbl_berita WHERE id_berita != '$id_berita' ORDER BY tanggal_dimasukkan DESC LIMIT 5";
                            ...
                            if (mysqli_num_rows($result_lainnya) > 0) {
                                while ($row_lainnya = mysqli_fetch_assoc($result_lainnya)) {
                                    $id_berita_lainnya = $row_lainnya['id_berita'];
                                    $gambar_lainnya = $row_lainnya['gambar']; 
                                    $judul_berita_lainnya = $row_lainnya['judul_berita'];
                                    $tanggal_dimasukkan_lainnya = $row_lainnya['tanggal_dimasukkan'];
                            ?>
                                    <li>
                                        <a href="detail_berita.php?id_berita=<?php echo $id_berita_lainnya; ?>">
                                            <div class="thumbnail-wrapper">
                                                <img src="admin/berita/gambar/<?php echo $gambar_lainnya; ?>" alt="" class="thumbnail">
                                            </div>
                                            <?php echo $judul_berita_lainnya; ?>
                                        </a>
