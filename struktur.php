    ...
    <div class="team-area separator pt-95 pb-70">
        <div class="container">
            ...
            <div class="team-list">
                <div class="row">
                    <?php
                        // Query SQL untuk mengambil data anggota dari tabel
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                // Menambahkan style ke gambar untuk mengatur tinggi maksimum
                                echo '<div class="col-xl-3 col-lg-3 col-md-6">
                                        <div class="team-wrapper mb-30">
                                            <div class="team-thumb">
                                                <img src="admin/foto/' . $foto . '" alt="' . $nama . '" style="max-width: 100%; height: 300px;">
                                            </div>
                            ...
                            echo "Tidak ada data anggota yang tersedia.";
                        }
                    ?>
                </div>
            </div>
