    ...
    <div class="testimonilas-area pt-100 pb-90">
        <div class="container">
            ...
            <div class="download-list">
                <div class="row">
                    <?php
                        $sql_dokumen = "SELECT * FROM dokumen"; // Mengambil semua data dari tabel dokumen
                        ...
                        while ($data_dokumen = mysqli_fetch_assoc($query_dokumen)) {
                            ...
                            $timestamp = time();
                            $download_url = "admin/foto/{$file_pdf}?timestamp={$timestamp}";
                            
                            // Mengecek apakah dokumen telah diunduh
                            if (isset($_GET['download']) && $_GET['download'] == $file_pdf) {
                                // Update jumlah unduhan di database
                                mysqli_query($koneksi, "UPDATE dokumen SET download = download + 1 WHERE file = '{$file_pdf}'");
                            }
                            ?>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card shadow">
                                    <div class="card-body">
                                        <h5 class="card-title"><?= $nama_dokumen ?></h5>
                                    </div>
                                    <div class="card-footer">
                                        <a href="<?= $download_url ?>&download=<?= $file_pdf ?>" class="btn btn-primary" download>
