                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li>
                                                    <a href="index_2.php">Home style 2</a>
                                                </li>
                                                <li>
                                                    <a href="index_3.php">Home style 3</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <ul class="submenu">
                                                <li>
                                                    <a href="course_01.php">Courses 01</a>
                                                </li>
                                                <li>
                                                    <a href="course_02.php">Courses 02</a>
                                                </li>
                                                <li>
                                                    <a href="course_03.php">Courses 03</a>
                                                </li>
                                                <li>
                                        ...
                                        <li>
                                            <a href="events_01.php">Events</a>
                                            <ul class="submenu">
                                                <li>
                                                    <a href="events_01.php">Events 01</a>
                                                </li>
                                                <li>
                                                    <a href="events_02.php">Events 02</a>
                                                </li>
                                                <li>
                                                    <a href="event_details.php">Events Details</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="grid_news.php">Blog</a>
                                            <ul class="submenu">
                                                <li>
                                                    <a href="grid_news.php">Blog 3 Column</a>
                                                </li>
                                                <li>
                                                    <a href="standard_blog.php">Blog Sidebar</a>
                                                </li>
                                                <li>
                                                    <a href="news_details.php">Blog Details</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
