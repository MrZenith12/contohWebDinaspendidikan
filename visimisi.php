    ...
    <div class="team-area separator pt-95 pb-70">
        <div class="container">
                ...
                <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                    <div class="section-title mb-50 text-center">
                        <div class="section-title-heading mb-20">
                            <h1 class="primary-color">Visi dan Misi <?php echo date("Y"); ?></h1>
                        </div>
                    </div>
                </div>
            </div>
            <div class="team-list">
                <div class="row">
                    <?php
                    // Query SQL untuk mengambil data dari tabel tbl_visi_misi
                    $sql = "SELECT * FROM tbl_visimisi";
                    $result = mysqli_query($koneksi, $sql);

                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            $gambar_visi_misi = $row['gambar'];
                            $visi = $row['visi'];
                            $misi = $row['misi'];
                            ...
                            echo '<div class="col-md-6">
                                    <article class="mb-4">
                                        <div class="article-image">
                                            <img src="admin/foto/' . $gambar_visi_misi . '" alt="' . $visi . '" style="width: 100%; max-height: 300px; object-fit: cover; border-radius: 10px;">
                                        </div>
                                        <div class="article-content text-center" style="background-color: #f7f7f7; padding: 20px; border-radius: 10px; margin-top: 10px;">
                                            <h2 class="article-title">Visi</h2>
                                            <p class="article-text">' . $visi . '</p>
                                            <h2 class="article-title">Misi</h2>
                                            <p class="article-text">' . $misi . '</p>
                                        </div>
                                    </article>
                                </div>';
                        }
                        ...
                        echo '<div class="col-md-12 text-center">
                                <p>Tidak ada data visi dan misi yang tersedia.</p>
                            </div>';
                    }
                    ?>
                </div>
